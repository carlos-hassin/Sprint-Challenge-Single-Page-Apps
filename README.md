...
> Answer: Client-side routing is faster to use becuase it's not constantly communicating with a server eveytime you navigate to another part of the website.
